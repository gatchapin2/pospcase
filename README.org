...
* Before Writing Your Font-Lock Keywords
  ...
  This is largely due to my design choice to keep implementation
  straightforward at the cost of accessibility. Of course I agree
  leaky abstraction is bad. If I find better way, maybe I’m going to
  drastically overhaul ~pospcase-font-lock~.

  But for now, there are some ideas you need to know before writing
  your original font-lock keywords.
